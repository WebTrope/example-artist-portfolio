      ...
      <Navbar fluid={false} className='bg-nav'>
        <Navbar.Brand href='/' className='nav-brand'>
          <img
            ...
            alt='webtrope logo'
          />
          <span className='font-heading self-center whitespace-nowrap dark:text-white'>
            WebTrope
          </span>
        </Navbar.Brand>
        <div className='flex md:order-2 nav-icons'>
          <div className='flex-row flex gap-2'>
            <a
              ...
              className='flex flex-col justify-center align-center text-gray-700 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white'
            >
              <svg
            ...
            <a
              href='https://instagram.com/web.trope'
              target='_blank'
              rel='noopener noreferrer'
              className='flex flex-col justify-center align-center text-gray-700 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white'
            >
            ...
            <a
              href='https://github.com/webtrope'
              target='_blank'
              rel='noopener noreferrer'
              className='flex flex-col justify-center align-center text-gray-700 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white'
            >
